package com.youedata.daas.core.exception;
 ...
 */
public class DaasException extends RuntimeException {
	...
	protected DaasException(int friendlyCode, String friendlyMsg, String urlPath) {
		this.setValues(friendlyCode, friendlyMsg, urlPath);
	}

	public DaasException(DaasExceptionEnum bizExceptionEnum) {
