 ...
 */
public class ReturnJsonTypeHandler extends BaseTypeHandler<JSONObject> {
    @Override
    ...
    public JSONObject getNullableResult(ResultSet rs, String columnName)
        ...
        return JsonUtil.parse(rs.getString(columnName), JSONObject.class);
    }

    @Override
    public JSONObject getNullableResult(ResultSet rs, int columnIndex) throws SQLException {

        return JsonUtil.parse(rs.getString(columnIndex), JSONObject.class);
    }
    ...
    public JSONObject getNullableResult(CallableStatement cs, int columnIndex)
        ...
        return JsonUtil.parse(cs.getString(columnIndex), JSONObject.class);
    }
}
