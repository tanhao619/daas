...
//	}
	 ...
	 * @param date:时间点
	 *            1:分钟,2:小时,3:日,4:周,5:月,6年
	 * @return
	 */
	public static String getCron(Date date, Integer cycle){
		String dateFormat="ss mm HH dd MM ? yyyy";
		String per = "/1";
		if (null == cycle){
			return formatDateByPattern(date,dateFormat) + "/25";
		}
		String[] split = formatDateByPattern(date,dateFormat).split(" ");
		String var = null;
		switch (cycle){
			case 1://分钟
				split[1] = split[1] + per;
